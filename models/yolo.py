...
# from ..modules import Conv, DFL, C2f
# from .block import *
# from .afpn import AFPN_P345, AFPN_P2345
# from .afpn import



from ultralytics.yolo.utils.tal import dist2bbox, make_anchors
sys.path.append("C:\yolo-afpn - ota\models")

# from extra_modules import CSPStage
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv,C3_MHSA,MHSAPLv31,Bottleneck_DSConv,DSConv2D,C3_DSConv,
            BottleneckCSP, C3, C3TR,C3STR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x,LDepthWiseConv,C3L_conv}:
            c1, c2 = ch[f], args[0]
            if c2 != no:  # if not output
                c2 = make_divisible(c2 * gw, 8)

            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C3, C3TR,C3STR, C3Ghost, C3x,C3L_conv,VoVGSCSP,VoVGSCSPC,C3_DSConv}:
        ...
        # TODO: channel, gw, gd
            ...
            c2 = ch[f] // args[0] ** 2
        elif m in {ASFF_2,ASFF_3,ASFF_4,Convafpn,C3afpn,}:
            c2 = args[0]
            if c2 != no:  # if not output
                c2 = make_divisible(c2 * gw, 8)
            args[0] = c2
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5s-bi-afpn-v4.3cw.yaml', help='model.yaml')
